...
-------------------------------------------
NOTE:
this file might be incomplete, feel free to post questions on Discussion board or email us
'''
...
# Resize the images from 32*32 to 45*45
# Normalize the images so that their intensity values are in range (-1,1)
...
class Modified(nn.Module):
    def __init__(self):
        ...
        self.fc = layer4
        # The maximum channel number will be 64*3*3 = 576
...
optimizer = optim.SGD(modified.parameters(), lr=0.01, momentum=0.95, weight_decay=1e-3)
